...
class RasaSkill(MycroftSkill):
    ...
    def __init__(self):
        ...
        self.rasa_host = "http://192.168.21.55:5085/"
    ...
    def handle_talk_to_rasa_intent(self, message):
        ...
        self.speak("La demostración de Leticia Banorte ha finalizado.")
    ...
    def handle_final_output(self, message, attempts=0):
        ...
        if "buttons" in message:
            ...
            option_list = ["option " + str(i+1) for i in range(len(buttons))]
            ...
            print("trying attempt " + str(attempts))
    ...
    def on_failed_button(self, utt):
        return "Lo siento, no capté eso."

    def get_rasa_response(self, utterance):
        if ("stop" in utterance.lower()) or ("para" in utterance.lower()) or ("detente" in utterance.lower()):
            self.conversation_active = False
            return [{"text": "Desconectándose, espere un momento por favor"}]
    ...
    def hit_rasa(self, utterance):
        ...
        print("sending " + str(utterance) + "to " + str(self.append_endpoint))
        ...
        while action != "action_listen":
            ...
            print("sending " + str(action) + "to " + str(self.action_endpoint))
